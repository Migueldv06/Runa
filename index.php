...
<head>
    ...
    <style>
        * {
        ...
        .subtitle a {
            color: #004b49;
            /* Azul escuro institucional para links */
...
<body>
    <div class="login-container">
        <div class="login-box">
            ...
            <h1>Login</h1>
            <p class="subtitle">
                Acesse sua conta ou <a href="criar-validar.php">crie uma nova</a>
            </p>

            <?php
            // Exemplo de como lidar com o envio do formulário (você precisará implementar a lógica de autenticação)
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                $username = $_POST["username"];
                $password = $_POST["password"];

                // Aqui você faria a verificação do usuário e senha no banco de dados
